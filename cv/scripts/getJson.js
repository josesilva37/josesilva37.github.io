...
function show(data){
    ...
    for(r of data.education){
        containerEducation.insertAdjacentHTML('beforeend','<div class="card"> <div class="row"><div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500"><div class="card-body cc-education-header"><p>' + r.startDate + '-' + r.endDate+ '</p><p>' + r.area+ '</p><p>+ ' +  r.studyType + ' </p><div class="h5"></div></div></div></div></div>');
    }
